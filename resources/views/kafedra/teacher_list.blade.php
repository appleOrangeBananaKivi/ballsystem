	...
	<div class="containe-fluid">
		<div class="row">
			...
			<div id="sidebar_left" class="col-2">
				...
				<br/>
				<a id="selected_sidebar_link" class="menu_link" href="teacher_list">
				...
				<div id="work_list_div" class="row content_div">
						...
						<form action="" method="get">
							<div class="row align-items-center">
								<div class="col-8">
									...
									<p>{{ $name }} kafedranyň mugallymlaryň reýtingy</p>
								</div>
								<div class="w-100"></div>
								<div class="col-4">
					...
					<div id="work_list_table" class="col">
						<table id="works_table">
							...
							<td>{{ $i1 }}</td>
							<td><a class="search_element" href="/ballsystem/public/teacher/{{ $teacher->login }}/work_list">{{ $teacher->name }}</a></td>
							@foreach($work_types as $work_type)
								@if(isset($main_balls[$i1 - 1]->type_balls[$i2]))
									<td class="text-center">{{ $main_balls[$i1 - 1]->type_balls[$i2] }}</td>
								@else
			...
			<div id="sidebar_right" class="col-3">
				...
				<div class="right_sidebar_list_item">
					<div class="row">
						...
						<div class="col-9">
							<h5>Mugallymlaryň reýtingy sahypasy</h5>
							<p>Tablisa görnüşindäki kafedra degişli bolan mugallymlaryň reýtingy</p>
						</div>
					</div>
				</div>
			</div>
