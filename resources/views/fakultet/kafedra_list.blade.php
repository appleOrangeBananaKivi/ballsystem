	...
	<div class="containe-fluid">
		<div class="row">
			...
			<div id="sidebar_left" class="col-2">
				...
				<br/>
				<a id="selected_sidebar_link" class="menu_link" href="kafedra_list">
				...
				<div id="work_list_div" class="row content_div">
					<div class="col">
						...
						<form action="" method="get">
							<div class="row align-items-center">
								<div class="col-8">
									<h5>Kafedralar reýtingy</h5>
									<p>{{ $name }} fakultetiň kafedralaryň reýtingy</p>
								</div>
								<div class="w-100"></div>
								<div class="col-4">
					...
					<div id="work_list_table" class="col">
						<table id="works_table">
							...
							<td>{{ $i }}</td>
							<td><a class="search_element" href="/ballsystem/public/kafedra/{{ $kafedra->login }}/teacher_list">{{ $kafedra->name }}</a></td>
							@foreach($work_types as $work_type)
							<td class="text-center">
								<?php 
									if(isset($kafedra_ratings[$i - 1]->type_balls[$i1]))
										echo($kafedra_ratings[$i - 1]->type_balls[$i1]);
									else
										echo(0);
								?>
							</td>
							<?php $i1++; ?>
							@endforeach
							<td>{{ $kafedra_ratings[$i - 1]->whole_ball }}</td>
							<?php $i++; ?>
							</tr>
							@endforeach
						</table>
			...
			<div id="sidebar_right" class="col-3">
				<h5>Kafedralar reýtingy sahypasy</h5>
				<p>Tablisa görnüşindäki kafedralaryň reýtingy</p>
				<hr/>
				<div class="right_sidebar_list_item">
					<div class="row">
						<div class="col-3">
							<img width="35" height="35" src="{{ URL::asset('pic/svg/building-regular.png') }}">
						</div>
						<div class="col-9">
							<h5>Kafedralar reýtingy sahypasy</h5>
							<p>Tablisa görnüşindäki fakultete degişli bolan kafedralaryň reýtingyy</p>
						</div>
					</div>
				</div>
			</div>
